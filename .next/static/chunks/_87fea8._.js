(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_87fea8._.js", {
...
const ParticleCursor = ()=>{
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Dynamically import the particlesCursor when the component mounts
        const loadParticlesCursor = async ()=>{
            const { particlesCursor } = await Promise.resolve().then(()=>__turbopack_external_require__('https://unpkg.com/threejs-toys@0.0.8/build/threejs-toys.module.cdn.min.js', true));
            // Initialize the particles cursor
            ...
            return ()=>{
                pc.destroy(); // Ensure to cleanup particles on unmount
            };
        };
        loadParticlesCursor();
    }, []);
...
//# sourceMappingURL=_87fea8._.js.map