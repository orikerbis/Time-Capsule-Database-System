...
async function POST(req) {
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT * FROM users WHERE email = ? OR username = ?", [
            email,
            username
        ]);
        if (rows.length > 0) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("INSERT INTO users (first_name, last_name, email, username, password_hash) VALUES (?, ?, ?, ?, ?)", [
            fullName,
            lastName,
            email,
            username,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__87adc7._.js.map