...
"[project]/src/app/api/addSharedUsers/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/data/db.ts [app-route] (ecmascript)"); // Assuming db is your database connection
;
;
async function POST(req) {
    ...
    `;
        ...
        const queries = values.map((value)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(query, [
                ...value,
                value[0],
                value[1],
                value[1]
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Shared users added successfully"
        }, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ee4afb._.js.map